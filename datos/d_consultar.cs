...
namespace datos
{
    public class D_consultar
    {
        ...
        public DataTable Mostrar()
        {
            ...
            //comando.CommandText = "Select * from objetos";
            // SP
        ...
        public void Descargar()
        {
            ...
            string filePath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.UserProfile), "Downloads", "excel.xlsx");

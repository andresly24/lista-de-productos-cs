...
namespace vista
{
    public partial class Form1 : Form
    {
        ...
        private void comprimirbtn_Click(object sender, EventArgs e)
        {
            ...
            homebtn.BackColor = Color.DodgerBlue;
        ...
        private void bjbtn_Click(object sender, EventArgs e)
        {
            blackjack uc = new blackjack();
            AddUC(uc);
            homebtn.BackColor = Color.DodgerBlue;
            comprimirbtn.BackColor = Color.DodgerBlue;
            listabtn.BackColor = Color.DodgerBlue;
            bjbtn.BackColor = SystemColors.MenuHighlight;
        }
    }
}

namespace vista
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            // comprimirbtn
            // 
            comprimirbtn.BackColor = Color.DodgerBlue;
            ...
            comprimirbtn.Image = (Image)resources.GetObject("comprimirbtn.Image");
            comprimirbtn.ImageAlign = ContentAlignment.MiddleLeft;
            comprimirbtn.Location = new Point(-1, 303);
            comprimirbtn.Name = "comprimirbtn";
            comprimirbtn.Padding = new Padding(5, 0, 0, 0);
            comprimirbtn.Size = new Size(221, 39);
            ...
            // listabtn
            // 
            listabtn.BackColor = Color.DodgerBlue;
            ...
            listabtn.Image = (Image)resources.GetObject("listabtn.Image");
            listabtn.ImageAlign = ContentAlignment.MiddleLeft;
            listabtn.Location = new Point(-1, 263);
            listabtn.Name = "listabtn";
            listabtn.Padding = new Padding(5, 0, 0, 0);
            listabtn.Size = new Size(221, 39);
            ...
            panel6.Controls.Add(bjbtn);
            panel6.Controls.Add(listabtn);
            panel6.Controls.Add(homebtn);
            panel6.Controls.Add(comprimirbtn);
            panel6.Controls.Add(logo);
            panel6.Location = new Point(12, 73);
            panel6.Name = "panel6";
            panel6.Size = new Size(220, 573);
            panel6.TabIndex = 14;
            // 
            // bjbtn
            // 
            bjbtn.BackColor = Color.DodgerBlue;
            bjbtn.Cursor = Cursors.Hand;
            bjbtn.FlatAppearance.BorderColor = Color.White;
            bjbtn.FlatAppearance.BorderSize = 0;
            bjbtn.FlatStyle = FlatStyle.Flat;
            bjbtn.Font = new Font("Segoe UI Semibold", 9F, FontStyle.Bold, GraphicsUnit.Point, 0);
            bjbtn.ForeColor = SystemColors.ControlLightLight;
            bjbtn.Image = (Image)resources.GetObject("bjbtn.Image");
            bjbtn.ImageAlign = ContentAlignment.MiddleLeft;
            bjbtn.Location = new Point(0, 343);
            bjbtn.Name = "bjbtn";
            bjbtn.Padding = new Padding(5, 0, 0, 0);
            bjbtn.Size = new Size(220, 39);
            bjbtn.TabIndex = 16;
            bjbtn.Text = "BlackJack21";
            bjbtn.UseVisualStyleBackColor = false;
            bjbtn.Click += bjbtn_Click;
            // 
            // screen
            // 

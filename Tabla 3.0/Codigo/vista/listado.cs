...
namespace vista
{
    public partial class listado : UserControl
    {
        ...
        {
            string dwnldPath = Environment.GetFolderPath(Environment.SpecialFolder.UserProfile) + @"\Downloads"; ;
            objetos.descargarp();
            MessageBox.Show("Se descargo el archivo en 'Downloads'");
            Process.Start("explorer.exe", dwnldPath);
        }
    }
}
